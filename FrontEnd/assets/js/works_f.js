...
async function getWorks(){
    ...
    let reponseprojets = await projets.json();
    return reponseprojets;
}

const lesProjets = getWorks();


/* let copieprojets = [];
lesProjets.forEach(function (item) {
    copieprojets.push(item);
});
console.log(copieprojets); */


/* lesProjets.forEach((element) => console.log(element)); */

/* const laGalerie = document.querySelector("div.gallery");
for (const projet in lesProjets) {
